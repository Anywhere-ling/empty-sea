...
func _ready() -> void:
	event_bus.subscribe("战斗_效果的行动_加入", _战斗_效果的行动_加入的信号)
...
func 效果处理(eff:Array, fea:Array = [], tar:Array = []) -> Array:
	...
	event_bus.push_event("战斗_请求检查图形化数据的改变")
	return ret




func _战斗_效果的行动_加入的信号(life:战斗_单位管理系统.Life_sys, card:战斗_单位管理系统.Card_sys, pos:战斗_单位管理系统.Card_pos_sys) -> void:
